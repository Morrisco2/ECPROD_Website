    ...
    <nav className='grid w-screen bg-gray-200 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3'>
      ...
      <div className='bg-white md:rounded-tl-3xl lg:rounded-tl-3xl col-span-2 flex sm:justify-start md:justify-end lg:justify-end pr-4 items-center'>
        <ul className=' flex flex-col px-5 py-5 sm:px-5 sm:py-5 md:justify-between lg:justify-between md:items-center lg:items-center gap-2  sm:flex-col md:flex-row lg:flex-row '>
          <li><Link href="#" className='px-4 py-2 rounded-3xl bg-[#00521f] text-white'>Home</Link></li>
          <li><Link href="#" className='px-4 py-2 rounded-3xl hover:bg-gray-200 hover:text-green-950 transition duration-200 ease-in '>About Us</Link></li>
          <li><Link href="#" className='px-4 py-2 rounded-3xl hover:bg-gray-200 hover:text-green-950 transition duration-200 ease-in'>Our Services</Link></li>
          <li><Link href="#" className='px-4 py-2 rounded-3xl hover:bg-gray-200 hover:text-green-950 transition duration-200 ease-in'>Contact Us</Link></li>
        </ul>
      </div>
    </nav>
  )
